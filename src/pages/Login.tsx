    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-background">
      ...
      <LiquidGlassCard className="w-full max-w-md mx-auto" glassSize="lg">
        ...
        <form onSubmit={handleLogin}>
          {/* Email Field */}
          <div className="mb-6">
            <Label htmlFor="email" className="text-foreground block mb-2">Email Address</Label>
            <Input
              id="email"
              type="email"
          ...
          {/* Password Field */}
          <div className="mb-6">
            <Label htmlFor="password" className="text-foreground block mb-2">Password</Label>
            <Input
              id="password"
              type="password"
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            <Link href="/reset-password" className="text-sm text-accent hover:text-accent/80 hover:underline transition-colors">
              Forgot password?
            </Link>
          </div>
          ...
          <Button
            type="submit"
            className="w-full mb-8 bg-accent hover:bg-accent/90 text-accent-foreground shadow-lg transition-all duration-200"
            size="lg"
            disabled={loading}
          >
        ...
        {/* Google Login Button */}
        <Button
          className="w-full mb-8 bg-secondary hover:bg-secondary/80 text-secondary-foreground transition-colors"
