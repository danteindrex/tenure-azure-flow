        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`bg-input text-foreground placeholder-muted-foreground transition-colors ${fieldValidation.email.touched
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={`bg-input text-foreground placeholder-muted-foreground transition-colors ${fieldValidation.password.touched
