-- =====================================================
-- Update Trigger: Include Address Fields
-- =====================================================
...
BEGIN
  ...
  -- Insert new member record with address fields
...
COMMENT ON FUNCTION public.handle_new_user() IS 'Automatically creates a Member record with full address when a user signs up via Supabase auth';

SELECT 'Trigger updated successfully with address fields!' as status;
