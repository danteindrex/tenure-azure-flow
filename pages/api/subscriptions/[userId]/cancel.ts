...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    console.log(`Forwarding cancel request to: ${subscriptionServiceUrl}/api/subscriptions/${userId}/cancel`);

    const serviceResponse = await fetch(`${subscriptionServiceUrl}/api/subscriptions/${userId}/cancel`, {
      method: 'POST',
      headers: {
